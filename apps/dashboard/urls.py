...
urlpatterns = [
    ...
    path('predictions/override-criticality/', OverrideCriticalityView.as_view(), name='override_criticality'),
    ...
    path('audit-log/export/', AuditLogExportView.as_view(), name='auditlog_export'),
